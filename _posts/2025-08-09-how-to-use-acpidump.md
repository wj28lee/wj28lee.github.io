...
---
리눅스 시스템에서 종종 ACPI tables 정보를 확인해야할 때가 있다. 예를 들어, CXL 장치에 대한 NUMA nodes를 구성하기 위해 커널이 활용하는 raw data를 직접 조회하고자 할 때처럼 말이다.

이 때는 **The ACPI Component Architecture (ACPICA) project**에서 제공하는 툴을 활용하면 된다.
